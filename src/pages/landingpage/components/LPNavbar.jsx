    ...
    <header className="sticky z-100 top-0 left-0 w-full bg-[#fafafa]">
      <div className="flex justify-between h-full px-5 py-2 items-center ">
        ...
        <div
          ...
          className="cursor-pointer border-2 md:hidden p-2 rounded-sm border-[#fbc02d] transition-all duration-300 ease-in-out hover:bg-[#ffe9b0] hover:text-white"
        >
          <svg
      ...
      >
        ...
        <NavLink
          ...
          className="bg-[#fbc02d] px-10 rounded-sm py-2"
        >
          Login
        </NavLink>
      </div>
