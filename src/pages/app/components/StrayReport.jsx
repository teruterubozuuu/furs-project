...
export default function StrayReport({ onClose, goBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "stray_animal_posts"), reportData);
  ...
  return (
    <div>
      ...
      <h1 className="text-center font-semibold text-lg text-[#2e7d32]">Report Stray Animal Sighting</h1>
